...
python main.py --net Diff --dataset Cora --patience 500 --epochs 2000 --loss_type bs --T 20 --alpha 0.1 --lr 0.1 --feat_dim 128 --no_feat_norm --weight_decay 0.005 --no_pseudo
